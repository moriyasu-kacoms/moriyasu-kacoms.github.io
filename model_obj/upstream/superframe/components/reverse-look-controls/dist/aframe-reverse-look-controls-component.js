...
/***/ function(module, exports) {
	...
	AFRAME.registerComponent('reverse-look-controls', {
	  ...
	  onMouseMove: function (event) {
	    ...
	    var multiplier = this.data.reverse ? -1 : 1;
	    yawObject.rotation.y -= movementX * 0.002 * multiplier;
	    pitchObject.rotation.x -= movementY * 0.002 * multiplier;
